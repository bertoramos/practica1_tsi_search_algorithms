...
class BranchBoundQueue(Queue):
    """A Branch And Bound Optimization Queue."""
    ...
    def extend(self, items):
        self.A.extend(sorted(items, key=lambda node: node.path_cost))
...
class HeuristicBranchBoundQueue(Queue):
    """A Branch And Bound Optimization Queue."""
    ...
    def extend(self, items):
        self.A.extend(sorted(items, key=lambda node: (node.path_cost + self.problem.h(node))))
